...
namespace DomainObjects
{
    ...
    public class ISDBSatelliteProvider : Provider
    {
        ...
        public ISDBSatelliteProvider(string name)
            : base(name)
        {
            string[] parts = Name.Split(new char[] { ' ' });
            if (parts.Length == 1)
        ...
        public static void Load()
        {
            ...
            var directoryName = Path.Combine(RunParameters.DataDirectory, "TuningParameters", "isdbs");
            ...
            if (directoryInfo.Exists)
            {
                ...
                foreach (var fileInfo in directoryInfo.EnumerateFiles("*.xml"))
                {
                    ...
                    var provider = new ISDBSatelliteProvider(name);
