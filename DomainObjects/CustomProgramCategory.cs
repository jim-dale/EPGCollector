...
namespace DomainObjects
{
    ...
    /// </summary>
    public class CustomProgramCategory : IEventCategory
    {
        /// <summary>
        ...
        /// </summary>
        public string XmltvDescription { get { return CustomDescription; } }
        ...
        /// <summary>
        /// Find a category matching an EPG title or description.
        /// </summary>
        /// <param name="inputString">The string that may contain the category tag.</param>
        /// <returns>The category object or null if the category is undefined.</returns>
        public static CustomProgramCategory FindCategoryFromInput(string inputString)
        {
        ...
        {
            CustomProgramCategory category = FindCategoryFromInput(inputString);
            if (category == null)
                return null;
            else
