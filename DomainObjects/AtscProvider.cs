...
namespace DomainObjects
{
    ...
    public class AtscProvider : Provider
    {
        ...
        public static void Load()
        {
            ...
            var directoryName = Path.Combine(RunParameters.DataDirectory, "TuningParameters", "atsc");
            ...
            if (directoryInfo.Exists)
            {
                ...
                {
                    var provider = new AtscProvider(fileInfo.Name.Substring(0, fileInfo.Name.Length - 4));
