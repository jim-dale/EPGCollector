...
namespace DomainObjects
{
    ...
    public class ClearQamProvider : Provider
    {
        ...
        public static void Load()
        {
            ...
            var directoryName = Path.Combine(RunParameters.DataDirectory, "TuningParameters", "clear QAM");
            ...
            if (directoryInfo.Exists)
            {
                ...
                foreach (var fileInfo in directoryInfo.EnumerateFiles("*.xml"))
                {
                    var provider = new ClearQamProvider(fileInfo.Name.Substring(0, fileInfo.Name.Length - 4));
