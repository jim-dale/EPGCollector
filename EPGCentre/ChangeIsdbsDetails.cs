...
namespace EPGCentre
{
    ...
    {        
        ...
        private void btOK_Click(object sender, EventArgs e)
        {
            ...
            if (!newFrequency)
            {
                ISDBSatelliteFrequency satelliteFrequency = satellite.FindFrequency(frequency) as ISDBSatelliteFrequency;
                ...
                else
                {
                    ...
                    ISDBSatelliteFrequency addFrequency = new ISDBSatelliteFrequency();
