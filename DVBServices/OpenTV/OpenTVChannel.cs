...
namespace DVBServices
{
    ...
    public class OpenTVChannel : Channel
    {
        ...
        private void getEventCategory(OpenTVTitleData titleData, EPGEntry epgEntry)
        {
            ...
            {
                IEventCategory overrideCategory = getCustomCategory(epgEntry.EventName, epgEntry.ShortDescription);
            ...
            IEventCategory customCategory = getCustomCategory(epgEntry.EventName, epgEntry.ShortDescription);
            if (customCategory != null)
                epgEntry.EventCategory = new EventCategorySpec(customCategory);
        }

        private IEventCategory getCustomCategory(string title, string description)
        {
            IEventCategory category = CustomProgramCategory.FindCategoryFromInput(title);
            if (category != null)
                return (category);

            return (CustomProgramCategory.FindCategoryFromInput(description));
        }
